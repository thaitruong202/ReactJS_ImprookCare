...
const CanceledAppointment = () => {
    ...
    const loadCanceledAppointment = async () => {
        try {
            ...
            setCanceledAppointment(res.data.content)
    ...
    const loadCanceledAppointmentPage = async (pageNumber) => {
        try {
            setLoading(true);
            let e = endpoints['booking-user-view-page']
    ...
    const handlePageChange = (pageNumber) => {
        ...
        loadCanceledAppointmentPage(pageNumber);
        ...
        <div>
            <div>
                <Table striped bordered hover>
                    ...
                    <tbody>
                        {Object.values(canceledAppointment).map((ca, index) => {
                            ...
                            if (ca.bookingCancel === true)
                                return <>
                                    <tr key={index}>
                                        ...
                                        <td><Badge bg="warning">{ca.statusId.statusValue}</Badge></td>
