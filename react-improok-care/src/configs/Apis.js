...
export const endpoints = {
  ...
  districts: (provinceCode) =>
    `${SERVER_CONTEXT}/api/public/provinces/${provinceCode}/districts/`,
  wards: (districtCode) =>
    `${SERVER_CONTEXT}/api/public/districts/${districtCode}/wards/`,
  "load-profile-patient": (userId) =>
    `${SERVER_CONTEXT}/api/auth/user/${userId}/profile-patient/`,
  "view-profile-patient": (profilePatientId) =>
    `${SERVER_CONTEXT}/api/auth/profile-patient/${profilePatientId}/`,
  "update-profile-patient": `${SERVER_CONTEXT}/api/auth/update-profile-patient/`,
  "load-profile-doctor-by-userId": (userId) =>
    `${SERVER_CONTEXT}/api/public/user/${userId}/profile-doctor/`,
  "load-profile-doctor-by-Id": (profileDoctorId) =>
    `${SERVER_CONTEXT}/api/public/profile-doctor/${profileDoctorId}/`,
  ...
  "time-slot": (timeDistanceId) =>
    `${SERVER_CONTEXT}/api/public/timeDistance/${timeDistanceId}/timeSlot/`,
  ...
  "load-medicine-by-Id": (medicineId) =>
    `${SERVER_CONTEXT}/api/public/medicines/${medicineId}/`,
  ...
  "prescription-detail-by-prescription-id": (prescriptionId) =>
    `${SERVER_CONTEXT}/api/auth/prescription/${prescriptionId}/prescription-detail/`,
  ...
  "load-comments-page": (profileDoctorId) =>
    `${SERVER_CONTEXT}/api/public/profile-doctor/${profileDoctorId}/comments/`,
  ...
  "get-message-for-all-view": (profileDoctorId, userId) =>
    `${SERVER_CONTEXT}/api/auth/profileDoctor/${profileDoctorId}/get-message-detail/${userId}/`,
  "get-user-send-message-to-doctor": (profileDoctorId) =>
    `${SERVER_CONTEXT}/api/auth/profileDoctor/${profileDoctorId}/get-user-send-message-to-doctor/`,
  ...
  "get-doctor-send-message-to-user": (userId) =>
    `${SERVER_CONTEXT}/api/auth/user/${userId}/profile-doctor-message/`,
  "booking-doctor-view-page": `${SERVER_CONTEXT}/api/auth/booking-doctor-view-page/`,
  "check-timeslot-register": (timeDistanceId) =>
    `${SERVER_CONTEXT}/api/auth/doctor/timeDistance/${timeDistanceId}/timeSlot-check-register/`,
  ...
  "load-custom-timeslot": (profileDoctorId) =>
    `${SERVER_CONTEXT}/api/auth/doctor/profileDoctor/${profileDoctorId}/timeSlot-for-doctor/`,
